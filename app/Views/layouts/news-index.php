                    ...
                    <div class="d-flex flex-column flex-md-row align-items-center justify-content-between order-md-2 w-100 w-md-auto">
                        ...
                        <div class="dropdown status-dropdown pr-md-3 mt-3 mt-md-0 border-right btn-new order-md-1">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton03">
                                <a class="dropdown-item" href="<?= !empty($data['query']) ? base_url('berita?query=' . $data['query'] . '&filter=terbaru') : base_url('berita?filter=terbaru') ?>">Terbaru</a>
                                <a class="dropdown-item" href="<?= !empty($data['query']) ? base_url('berita?query=' . $data['query'] . '&filter=terlama') : base_url('berita?filter=terlama') ?>">Terlama</a>
                            </div>
                        </div>
                    </div>
                    <div class="pr-md-3 mb-3 mb-md-0 order-2 order-md-1 w-100 w-md-auto">
                        <a href="<?= base_url('berita/tambah') ?>" class="btn btn-primary w-100 w-md-auto"><i class="bi bi-plus mr-1"></i>Tambah Baru</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card-transparent mb-0">
            <div class="card-header d-flex align-items-center justify-content-between p-0 pb-3">
                <div class="header-title">
                    <h4 class="card-title">Berita Aktif</h4>
                </div>
            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                                            ...
                                            <div class="media align-items-center ml-auto mt-md-0 mt-3">
                                                <a href="<?= base_url('berita/' . $result['id']) ?>" class="btn bg-primary-light mr-2"><i class="bi bi-pen"></i>Edit</a>
                                                <a href="<?= base_url('berita/' . $result['id']) . '/delete' ?>" class="btn bg-secondary-light"><i class="bi bi-trash m-0"></i></a>
                                            </div>
                                        </div>  
                                    </div>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <?php if($result['attachment'] != null): ?>
                                                        <div class="text-center pt-3 border-top">
                                                            <a href="<?= base_url('uploads/berita/' . $result['attachment']) ?>" class="btn btn-outline-secondary"><i class="bi bi-file-earmark mr-2"></i>Headline</a>
                                                        </div>
                                                    <?php endif; ?>
                                                </div>
                                                <div class="modal-footer border-0 justify-content-center">
                                                    <a href="<?= base_url('berita/' . $result['id']) ?>" class="btn bg-primary-light"><i class="bi bi-pen"></i>Edit</a>
                   ...
                   <?php else: ?>
                        <div class="col-12">
                            <div class="alert alert-warning w-100" role="alert">
                                <div class="iq-alert-text">Tidak ada berita.</div>
                            </div>
                        </div>
                    <?php endif; ?>
                </div>
