...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Pengajuan Data</li>
    </ol>
</nav>
<?= $this->endSection() ?>
                                ...
                                <div class="d-flex flex-wrap align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        <button type="button" class="btn p-0" data-toggle="modal" data-target="#announcementModal1">
                                            <h5 class="text-left mb-2">Lorem Nama Ipsum</h5>
                                            <div class="media align-items-center flex-wrap">
                                                ...
                                                <div class="text-muted"><i class="bi bi-building mr-2"></i>PT Lorem Ipsum</div>
                                            </div>
                                        </button>
                                    </div>
