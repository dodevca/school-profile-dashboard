    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php endif; ?>
                <?= form_open_multipart('/pengumuman/create') ?>
                    <?= csrf_field() ?>
                    ...
                    <div class="form-group">
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label" for="attachment">Unggah lampiran</label>
                        </div>
                    </div>
                    <div class="alert alert-warning mb-3" role="alert">
                        <div class="checkbox">
                            <label class="mb-0" for="important"><input type="checkbox" class="mr-2" name="important" value="1">Tandai sebagai pengumuman penting</label>
                        </div>
                    </div>
